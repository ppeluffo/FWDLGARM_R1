...
/*
 * ⛔ `0x00300` estuvo asignado a FLOWCONTROL y **quedó libre** al eliminarlo
 * (2026-09-22, ver CLAUDE.md). NO reutilizar esa dirección para otra cosa: si
 * algún día vuelve el bloque, que caiga donde estaba.
 */
